...
import com.signalcollect.storage.CachedBerkeley

/**
 *  The cached Berkeley DB storage factory creates storage objects that store vertices in Berkeley DB.
 *  Some vertices are cached in memory.
 */
